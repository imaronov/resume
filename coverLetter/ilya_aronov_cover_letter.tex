...
%     Company Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\possitionApplied{React.js Developer}
\def\hiringManager{Hiring Manager}
\def\companyName{DRF Water Heating Solutions}
\def\companyAddress{2344 Crestover Ln,}
\def\companyCity{Wesley Chapel, FL 33544}
\def\companyMission{to provides domestic hot water systems for residential, multi-family, university, and commercial properties}
...
\def\companySkills{React.js, GraphQL, TypeScript, JUnit, RESTful services, and microservices architecture}
