...
\def\companySkills{JavaScrip, TypeScript, ReactJS, Java, Spring Boot, MySQL, GraphQL, RESTful services, MicroServices}

\def\companyMission{to be a foundation of strength, committed to
meeting the needs of customers, serving society, and fostering shared and sustainable growth for a
better world while delivering shareholder value}
