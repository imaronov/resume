...
\def\hiringManager{Kirti Singh}
\def\companyName{Diverse Team}
\def\companyAddress{330 Washington St, PMB 390}
\def\companyCity{Hoboken, NJ 07030}
% \def\companyMission{building visual development platform for building powerful websites without writing code}
\def\companyMission{dedicated to crafting high-quality, efficient, and user-friendly solutions}
\def\companySkills{AWS, Java, JavaScript, React, REST, Web / Micro Services, and Kubernates}
