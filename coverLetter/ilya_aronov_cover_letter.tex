...
\def\companyName{Ascendion}
\def\companyAddress{3505 E Frontage Rd Suite 325}
\def\companyCity{Tampa, FL 33607}
\def\companySkills{Java, Node, JavaScript, TypeScript, React, Redux, JSON, CI/CD, MySQL, GraphQL, RESTful services, MicroServices, and Kubernetes}

\def\companyMission{to empower growth and innovation through tailored digital engineering solutions}
