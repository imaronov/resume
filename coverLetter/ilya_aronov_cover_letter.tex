...
%     Company Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\possitionApplied{Application Developer}
\def\hiringManager{Hiring Manager}
\def\companyName{Accenture}
\def\companyAddress{140 Fountain Parkway}
\def\companyCity{St. Petersburg, FL, 33716}
...
\def\companySkills{Java, Javascript, Typescript, ReactJS, RESTful / microservices, and Kubernetes}
