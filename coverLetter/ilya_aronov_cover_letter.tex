...
%     Company Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\possitionApplied{Full Stack Developer}
\def\hiringManager{Hiring Manager}
\def\companyName{CodeTru}
\def\companyAddress{9385 N 56th St}
\def\companyCity{Temple Terrace, Florida 33617}
\def\companyMission{empowering businesses of all sizes with cutting-edge technology solutions that drive growth, enhance efficiency, and deliver exceptional customer experiences}
% default mission statement bellow
% \def\companyMission{dedicated to crafting high-quality, efficient, and user-friendly solutions}
\def\companySkills{ various JavaScript libraries, React.js, Java, web services, and micro service architecture}
