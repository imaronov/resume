...
%     Company Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\possitionApplied{Full Stack Software Engineer Java ReactJs}
\def\hiringManager{Hiring Manager}
\def\companyName{Datagrate}
\def\companyAddress{111 2nd Ave NE Suite 614}
\def\companyCity{St. Petersburg, FL 33701}
\def\companySkills{Javascript, ReactJS, Redux, Java, Spring Boot, RESTful services, microservices, and Kubernetes}
