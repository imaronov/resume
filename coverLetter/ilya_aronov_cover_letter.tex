...
%     Company Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\possitionApplied{Software Engineer DevSecOps}
\def\hiringManager{Hiring Manager}
\def\companyName{MUFG Bank}
\def\companyAddress{4050 W. Boy Scout Boulevard}
\def\companyCity{Tampa, FL 33607}
\def\companySkills{Linux, Java, Node, JavaScript, TypeScript, ReactJS, JEST, CI/CD, microservices, and Kubernetes}

\def\companyMission{to be a foundation of strength, committed to meeting the needs of customers, serving society, and fostering shared and sustainable growth for a better world while delivering shareholder value}
