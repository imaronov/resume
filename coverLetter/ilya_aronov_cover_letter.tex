...
%     Company Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\possitionApplied{Principal Software Engineer}
\def\hiringManager{Hiring Manager}
\def\companyName{Reliaquest}
\def\companyAddress{1001 Water Street}
\def\companyCity{Tampa, FL 33602}
\def\companySkills{JavaScrip, TypeScript, ReactJS, Java, Spring Boot, MySQL, GraphQL, RESTful services, Microservice }

\def\companyMission{to make security possible}
